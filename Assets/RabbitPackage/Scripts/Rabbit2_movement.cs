//mAnim = GameObject.FindWithTag("Rabbit2").getComponent<Animator>();
using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class Rabbit2_movement : MonoBehaviour
{
    ...
    void Start()
    {
        //animator = GameObject.FindWithTag("Dancing_Rabit").GetComponentInChildren<Animator>();
